...
function GUI:CreateMain(config)
    local settings = {
        Name = config.Name or "Erennix",
        title = config.title or config.Title or "Erennix UI",
        ...
        Config = {
            ...
            FolderName = config.Config and config.Config.FolderName or "Erennix",
...
function GUI:Save()
    ...
    local HttpService = game:GetService("HttpService")
    local folderName = GUI.Settings.Config.FolderName or "Erennix"
    local fileName = GUI.Settings.Config.FileName or GUI.Settings.Name or "Erennix"
    local settingsData = {}
...
local main = GUI:CreateTab("Main", "home") -- Creates a Tab
